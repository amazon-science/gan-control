...
class NeuralNetPB(object):
    ...
    def _load_graph(self):
        ...
        for n in weight_nodes:
            self.weights[n.name] = tf.make_ndarray(n.attr['value'].tensor)
...
if __name__ == '__main__':
    ...
    neural_net_pb = NeuralNetPB('path tp FaceReconModel.pb')  # TODO: path to FaceReconModel.pb
    pytorch_resnet = resnet50()
    ...
    pytorch_resnet.eval()
    path = 'path to temp_pytorch_converted_model.pt'  # TODO: path to save pytorch model
